      ...
      <div className="paneHeader">
        <div>
          ...
          <p className="paneHint">
            Tables, kiosk-enabled tables, and manual bar seats share one responsive floor model so the console is not tied to a single fixed layout.
          </p>
        </div>
      </div>
              ...
              {group.items.map((location) => (
                ...
                >
                  ...
                  <div className="locationTileMeta">
                    ...
                    <span>{location.seatCount} seats</span>
                  </div>

                  <div className="tileStats">
                    <div>
                      <span className="tileLabel">Session</span>
                      <strong>{location.sessionOpen ? "Open" : location.manualOnly ? "Manual" : "Idle"}</strong>
                    </div>
                    <div>
